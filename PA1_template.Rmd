...
lot_av_inter_type_day<-plot_av_inter_type_day+labs(y="average number of steps accross all days", title="Average number of steps per interval, accross all days")
